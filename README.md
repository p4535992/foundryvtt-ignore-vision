...
- **Embedded feature of [GM Vision](https://github.com/dev7355608/gm-vision)** The module provides the feature to remove token movement animations for the GM. This is managed from a module setting.
