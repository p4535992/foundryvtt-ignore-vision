...
export class GmVisionHelpersV11 {
    ...
    static registerGmVision() {
        if (game.settings.get(CONSTANTS.MODULE_ID, "enableGmVision") && !game.modules.get("gm-vision")?.active) {
            ...
            GmVisionHelpersV11.activeGmVision = game.settings.get(CONSTANTS.MODULE_ID, "activeGmVision");
            ...
            Hooks.on("getSceneControlButtons", (controls) => {
                ...
                lighting.icon = GmVisionHelpersV11.activeGmVision ? "fa-solid fa-lightbulb" : "fa-regular fa-lightbulb";
            });
            ...
            Hooks.on("sightRefresh", (layer) => {
                revealFog.visible = GmVisionHelpersV11.activeGmVision;
                canvas.effects.illumination.filter.uniforms.gmVision = GmVisionHelpersV11.activeGmVision;
            });
            ...
            CONFIG.Token.objectClass = class extends CONFIG.Token.objectClass {
                ...
                get isVisible() {
                    ...
                    if (
                        (GmVisionHelpersV11.activeGmVision && !visible) || //  && active
                    ...
                    if (visible || GmVisionHelpersV11.activeGmVision) {
                        return true;
                    }
    ...
    static handleKeybindingGmVision(value) {
        ...
        game.settings.set(CONSTANTS.MODULE_ID, "activeGmVision", !GmVisionHelpersV11.activeGmVision);
    ...
    static handleGmVision(value) {
        ...
        GmVisionHelpersV11.activeGmVision = value;
